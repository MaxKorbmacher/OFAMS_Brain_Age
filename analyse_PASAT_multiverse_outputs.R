# Analyse cognitively stable or improving group (CSIG) vs cognitive loss group (CLG) multiverse outputs
#
...
coef_table$Formula = gsub('CLGc ', '',coef_table$Formula)
...
ggsave(plot = plot, filename = "/Users/max/Documents/Local/MS/results/CDG_multiverse.pdf", width = 8, height = 8)
#
